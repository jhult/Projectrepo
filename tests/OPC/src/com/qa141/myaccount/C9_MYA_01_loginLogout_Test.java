...
public class C9_MYA_01_loginLogout_Test extends BaseTest {
	...
	public void test(String browserName) {
		...
		try {
			 ...
			 * driver.manage().timeouts().pageLoadTimeout(Config.WAIT_FOR_SECONDS,
			 * TimeUnit.SECONDS);
			 * driver.manage().timeouts().implicitlyWait(Config.WAIT_FOR_SECONDS,
			 * TimeUnit.SECONDS); Thread.sleep(10000);
			 * 
			 * 
			 * ----- Verify Header on My Account Landing page ------
			 * System.out.println("Header: -"+
			 * driver.findElement(By.xpath(".//*[@id='pt1:header:h:macct-app-name']")).
			 * getText()); Assert.assertTrue(driver.findElement(By.xpath(
			 * ".//*[@id='pt1:header:h:macct-app-name']")).getText().contains("My Account"),
			 * "My Account");
			 * 
			 */
